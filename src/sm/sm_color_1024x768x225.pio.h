...
#define sm_color_1024x768x225_wrap_target 2
#define sm_color_1024x768x225_wrap 8
...
static inline pio_sm_config sm_color_1024x768x225_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + sm_color_1024x768x225_wrap_target, offset + sm_color_1024x768x225_wrap);
    return c;
}
