...
static inline pio_sm_config sm_color_640x480x175_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + sm_color_640x480x175_wrap_target, offset + sm_color_640x480x175_wrap);
    return c;
}
