...
static inline pio_sm_config sm_color_640x480x100_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + sm_color_640x480x100_wrap_target, offset + sm_color_640x480x100_wrap);
    return c;
}

static inline void sm_color_640x480x100_program_init(PIO pio, uint sm, uint offset, uint pin) {
    pio_sm_config c = sm_color_640x480x100_program_get_default_config(offset);
